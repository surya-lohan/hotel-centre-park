...
export default function WhyStaySection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl.fromTo(
        [textOverlayRef.current?.children || [], reasonsRef.current?.children || []].flat(),
        { y: 0, opacity: 1 },
  ...
  return (
    ...
    >
      ...
      <div
        ref={textOverlayRef}
        className="relative w-full px-6 py-8 lg:absolute lg:left-[3vw] lg:top-[8vh] lg:w-[42vw] lg:px-0 lg:py-0"
      >
      ...
      <div
        ref={reasonsRef}
        className="relative flex w-full flex-col gap-5 px-6 pb-10 lg:absolute lg:left-[3vw] lg:top-[38vh] lg:w-[44vw] lg:px-0 lg:pb-0"
      >
